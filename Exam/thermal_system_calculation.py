...
class FluidState:
    ...
    def specific_enthalpy(self):
        ...
        return PropsSI(
            Properties.SPECIFIC_ENTHALPY.value,
            ThermodynamicState.PRESSURE.value, self.pressure_pa,
            ThermodynamicState.TEMPERATURE.value, self.temp_k,
            self.fluid
        )
...
###################################################################################################
# Exercise 4
NUMBER_PROPERTIES_TO_DETERMINE_STATE = 3 # <= Set the right number here.
...
def get_humid_air_state(
    ...
    """Returns a thermodynamic state of the humid air
    ...
    Example:
        ...
        print(humid_air_state.pressure_pa)
        print(humid_air_state.specific_humidity_kg_per_kg_dry_air)
        
        parameter = {'pressure_pa': 101325, 'temperature_k': 298.15, 'relative_humidity': 0.5}
        humid_air_state = get_humid_air_state(**parameter)
    """
