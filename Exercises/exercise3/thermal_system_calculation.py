...
class HeatExchangerLMTD(HeatExchanger):
    ...
    def __init__(
        ...
        Arguments:
            ...
            is_parallel_flow: If the flow is in parallel 
        """
    ...
    def solve_temperature(self):
        ...
        if self.flow_hot_side.temp_out is not None:
            # Your code here. After you implement the code, delete the line with raise raise NotImplementedError("")
            self.flow_cold_side.temp_out = None
            raise NotImplementedError("You have not implemented the method yet.")


        # The case when the outlet temperature is known for the cold side
        else:
            # Your code here. After you implement the code, delete the line with raise raise NotImplementedError("")
            self.flow_hot_side.temp_out = None
            raise NotImplementedError("You have not implemented the method yet.")
    ...
    def heat_capacity_rate_min(self):
        """Returns heat capacity rate minimum"""
    ...
    def heat_transfer_rate_from_lmtd(self):
        ...
        # Your code here. After you implement the code, delete the line with raise raise NotImplementedError("")
        heat_transfer_rate_lmtd = None
        raise NotImplementedError("You have not implemented the method yet.")
        return heat_transfer_rate_lmtd
...
class HeatExchangerEffectivenessNTU(HeatExchanger):
    ...
    def heat_capacity_rate_min(self):
        ...
        # Your code here. After you implement the code, delete the line with raise raise NotImplementedError("")
        heat_capacity_rate_min = None
        raise NotImplementedError("You have not implemented the method yet.")
        return heat_capacity_rate_min

    @property
    def heat_capacity_rate_max(self):
        """Returns maximum heat capacity rate"""
        # Your code here. After you implement the code, delete the line with raise raise NotImplementedError("")
        heat_capacity_rate_max = None
        raise NotImplementedError("You have not implemented the method yet.")
        return heat_capacity_rate_max

    @property
    def heat_capacity_rate_ratio(self):
        """Returns heat capacity rate ratio (C_min / C_max)"""
        # Your code here. After you implement the code, delete the line with raise raise NotImplementedError("")
        heat_capacity_rate_ratio = None
        raise NotImplementedError("You have not implemented the method yet.")
        return heat_capacity_rate_ratio

    @property
    def heat_transfer_rate_max(self):
        """Returns maximum heat transfer rate"""
        # Your code here. After you implement the code, delete the line with raise raise NotImplementedError("")
        heat_transfer_rate_max = None
        raise NotImplementedError("You have not implemented the method yet.")
        return heat_transfer_rate_max
    ...
    def get_effectiveness_from_ntu(self, ntu: float = None):
        ...
        if self.flow_type == FlowType.Counter:
            ...
            raise TypeError("Flow type is not valid.")
